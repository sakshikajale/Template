...
<body><span class="align-middle"></span>
  ...
  <div class="row align-items-start">
    <div class="col">
      ...
      <form id="registrationForm" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
        <input type="text" class="form-control text-center mt-2 fw-bold" name="hh1" id="ihh1" value="|| श्री गणेशाय नम: ||" maxlength="70">
        ...
        <label for="birth_place" class="col-sm-4 col-form-label text-end">Birth Place:</label>
        <input type="text" id="birth_place" name="birth_place"><br><br>
        
        <label for="birth_time" class="col-sm-4 col-form-label text-end">Birth Time:</label>
        ...
        <label for="marital_status" class="col-sm-4 col-form-label text-end">Marital Status:</label>
        ...
        <label for="caste" class="col-sm-4 col-form-label text-end">Caste:</label>
        <input type="text" id="caste" name="caste"><br><br>
        
        <label for="height" class="col-sm-4 col-form-label text-end">Height:</label>
        <input type="text" id="height" name="height"><br><br>
        
        <label for="city" class="col-sm-4 col-form-label text-end">City:</label>
        <input type="text" id="city" name="city"><br><br>
    
        <label for="zodiac_sign" class="col-sm-4 col-form-label text-end">Zodiac Sign:</label>
        <input type="text" id="zodiac_sign" name="zodiac_sign"><br><br>
        
        <label for="education" class="col-sm-4 col-form-label text-end">Education:</label>
        <input type="text" id="education" name="education"><br><br>
        
        <label for="Profession" class="col-sm-4 col-form-label text-end">Profession:</label>
        <input type="text" id="Profession" name="Profession"><br><br>
       
        <label for="relative" class="col-sm-4 col-form-label text-end">Relative:</label>
